class MdnsScanner < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/CramBL/mdns-scanner/releases/download/v0.27.0/mdns-scanner-aarch64-apple-darwin.tar.gz"
    end
    if Hardware::CPU.intel?
      url "https://github.com/CramBL/mdns-scanner/releases/download/v0.27.0/mdns-scanner-x86_64-apple-darwin.tar.gz"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/CramBL/mdns-scanner/releases/download/v0.27.0/mdns-scanner-aarch64-unknown-linux-musl.tar.gz"
    end
    if Hardware::CPU.intel?
      url "https://github.com/CramBL/mdns-scanner/releases/download/v0.27.0/mdns-scanner-x86_64-unknown-linux-musl.tar.gz"
    end
  end
